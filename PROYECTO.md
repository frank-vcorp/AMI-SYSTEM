...
| mod-clinicas | MOD-CLINICAS | FASE 0 – Cimientos | 0 | Frontend · Backend | done | 90 | Implementación completa + correcciones QA aplicadas. Pendiente: tests + infra | core-database completado |
